...
int list_char::find_last(char search)
{
    ...
    if (index >= 0)
    {
        cout << "The character '" << search << "' was found in the list at position ";
        cout << index  << "." << endl;
    }
    else
    {
...
void list_char::remove(char item)
{
    bool in_list = false;
    char element;
    int count = 0;
    ...
    if (in_list == true)
        cout << "The character '" << item << "' was found in the list and removed " << count << " times." << endl;
    else
    {
        cout << "The character '" << item << "' was not found in the list." << endl;
        exit(1);
    }
    first();
}